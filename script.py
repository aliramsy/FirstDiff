...
if dataset in ['SWaT', 'PSM']:
    ...
    val = ValDatasetCSV(TRAIN_PATH[dataset], None, WINDOW_SIZE, STRIDE, 0.85, HISTORY_SIZE)
...
solver = Solver(history_model, dit_model, train_dataloader, val_dataloader, test_dataloader, diffusion=diffusion, mask_data=False, anomaly_ratio=0.05, experiment=experiment, history = HISTORY, device=device, gpu_id=GPU_ID)
